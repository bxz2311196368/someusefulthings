...
public class GuiLoader implements IGuiHandler
{
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z)
	{
		...
		case GUI_F_E_T:
			return new ForceEnchTableContainer(player, world.getTileEntity(new BlockPos(x, y, z)));
		case GUI_G_B:
			return new GarbageBagContainer(player);
		case GUI_C_T:
			return new CraftingTableContainer(player, world, new BlockPos(x, y, z));
		case GUI_W_B_C:
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z)
	{
		...
		{
		case GUI_R_E:
			return new RemoveEnchantmentGuiContainer(
					new RemoveEnchantmentContainer(player, world.getTileEntity(new BlockPos(x, y, z))));
		case GUI_C_E:
			return new CopyEnchantmentGuiContainer(
					new CopyEnchantmentContainer(player, world.getTileEntity(new BlockPos(x, y, z))));
		case GUI_R_M:
			return new ReinforcementMachineGuiContainer(
					new ReinforcementMachineContainer(player, world.getTileEntity(new BlockPos(x, y, z))));
		case GUI_P_I:
		...
		case GUI_F_E_T:
			return new ForceEnchTableGuiContainer(
					new ForceEnchTableContainer(player, world.getTileEntity(new BlockPos(x, y, z))));
		case GUI_G_B:
			return new GarbageBagGuiContainer(new GarbageBagContainer(player));
		case GUI_C_T:
			return new CraftingTableGuiContainer(new CraftingTableContainer(player, world, new BlockPos(x, y, z)));
		case GUI_W_B_C:
		...
		case GUI_F_F:
			return new FastFurnaceGuiContainer(new FastFurnaceContainer(player,
					(FastFurnaceTileEntity) world.getTileEntity(new BlockPos(x, y, z))));
		case GUI_M_S:
